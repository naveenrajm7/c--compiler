...
* Standard prelude:
  ...
  1:    LDA  4,-20(6) 	copy gp to sp &allocating global variables(if any)
...
* -> function:
 ...
 26:    LDA  4,-1(4) 	allocate for local variables
* -> compound
* -> assign
* -> array element
 27:    LDA  2,0(6) 	get global array address
...
* -> call
* -> array element
 44:    LDA  2,0(6) 	get global array address
